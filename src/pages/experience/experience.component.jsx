                    ...
                    <div>
                      <Card.Text className="text-center style">
                        ...
                        <ul className="text-left">
                          <li>
                            <strong>Developed &amp; enhanced</strong> the
                            website independantly, based on the input given by
                            the UI designer.
                          </li>
                          <li>
                          ...
                          <li>
                            ...
                            technology to enhance products and services that
                            focus on external customers as well as internal
                            workflow.
                          </li>
                        </ul>
                      </Card.Text>
                      ...
                      <Card.Text className="text-center style">
                        ...
                        <ul className="text-left">
                          <li>
                            ...
                            and it's various implementations with respect to
                            PCBs.
                          </li>
                          <li>
                            <strong>Design &amp; implementation</strong> of
                            various single and double sided PCBs including the
                            audio amplifier LM386, MAX7219 seven segement
                            driver, phone detector circuit and the TPS61097 step
                            up circuit.
                          </li>
                          <li>
                            <strong>Hardware implementation</strong> of the
                            double sided phone detector PCB was done using the
                            NVIS72 prototyping machine.
                          </li>
                          <li>
                            <strong>First</strong> intern to succesfully
                            implement a double sided PCB in the foundation.
                          </li>
                        </ul>
                      </Card.Text>
                    </div>
                      ...
                      <Card.Text className="text-center style">
                        ...
                        <ul className="text-left">
                          <li>
                            ...
                            wherein I worked with diverse, multi-cultural teams
                            to implement the sustainable development goals
                            globally.
                          </li>
                          <li>
                            Part of organizing committee of a national event as
